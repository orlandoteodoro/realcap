...
public class PrinterTester extends TestLog {
    ...
    private static br.com.realcapreal.realcapvendas.uteis.PrinterTester printerTester;
    ...
    public static br.com.realcapreal.realcapvendas.uteis.PrinterTester getInstance() {
        if (printerTester == null) {
            printerTester = new br.com.realcapreal.realcapvendas.uteis.PrinterTester();
        }
