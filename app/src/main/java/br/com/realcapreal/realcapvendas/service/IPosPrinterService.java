...
public interface IPosPrinterService extends android.os.IInterface
{
  ...
  public static class Default implements IPosPrinterService
  {
    /**
        * 打印机状态查询
        * @return 打印机当前状态
    ...
    /**
        ...
        */
    @Override
    public void printerInit(IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
        ...
        */
    @Override
    public void setPrinterPrintDepth(int depth, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
        ...
        */
    @Override
    public void setPrinterPrintFontType(String typeface, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
    	...
    	*/
    @Override
    public void setPrinterPrintFontSize(int fontsize, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
        ...
        */
    @Override
    public void setPrinterPrintAlignment(int alignment, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
        ...
        */
    @Override
    public void printerFeedLines(int lines, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
        ...
        */
    @Override
    public void printBlankLines(int lines, int height, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
        * 打印文字
        ...
        */
    @Override
    public void printText(String text, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
        ...
        */
    @Override
    public void printSpecifiedTypeText(String text, String typeface, int fontsize, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
        * 打印指定字体类型和大小文本，字体设置只对本次有效
        ...
        */
    @Override
    public void PrintSpecFormatText(String text, String typeface, int fontsize, int alignment, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
    	* 打印表格的一行，可以指定列宽、对齐方式
    	...
    	*/
    @Override
    public void printColumnsText(String[] colsTextArr, int[] colsWidthArr, int[] colsAlign, int isContinuousPrint, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
        * 打印图片
        ...
        */
    @Override
    public void printBitmap(int alignment, int bitmapSize, android.graphics.Bitmap mBitmap, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
    	* 打印一维条码
    	...
    	* @param textposition:	文字位置 0--不打印文字, 1--文字在条码上方, 2--文字在条码下方, 3--条码上下方均打印 br.com.realcapreal.realcapvendas.service.
    	* @param callback  执行结果回调
    	* @return
    	*/
    @Override
    public void printBarCode(String data, int symbology, int height, int width, int textposition, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
    	* 打印二维条码
    	...
    	*/
    @Override
    public void printQRCode(String data, int modulesize, int mErrorCorrectionLevel, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
    	*打印原始的byte数据
    	...
    	*/
    @Override
    public void printRawData(byte[] rawPrintData, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
    	* 使用ESC/POS指令打印
    	...
    	*/
    @Override
    public void sendUserCMDData(byte[] data, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    /**
    	* 执行打印
    	...
    	*/
    @Override
    public void printerPerformPrint(int feedlines, IPosPrinterCallback callback) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements IPosPrinterService
  {
     ...
     */
    public static IPosPrinterService asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
    ...
    public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        {
          data.enforceInterface(descriptor);
          IPosPrinterCallback _arg0;
          _arg0 = IPosPrinterCallback.Stub.asInterface(data.readStrongBinder());
        ...
        case TRANSACTION_setPrinterPrintDepth:
        {
          ...
          int _arg0;
          _arg0 = data.readInt();
          IPosPrinterCallback _arg1;
          _arg1 = IPosPrinterCallback.Stub.asInterface(data.readStrongBinder());
        ...
        case TRANSACTION_printBlankLines:
        {
          ...
          int _arg1;
          _arg1 = data.readInt();
          IPosPrinterCallback _arg2;
          _arg2 = IPosPrinterCallback.Stub.asInterface(data.readStrongBinder());
        ...
        case TRANSACTION_printSpecifiedTypeText:
        {
          ...
          int _arg2;
          _arg2 = data.readInt();
          IPosPrinterCallback _arg3;
          _arg3 = IPosPrinterCallback.Stub.asInterface(data.readStrongBinder());
        ...
        case TRANSACTION_PrintSpecFormatText:
        {
          ...
          int _arg3;
          _arg3 = data.readInt();
          IPosPrinterCallback _arg4;
          _arg4 = IPosPrinterCallback.Stub.asInterface(data.readStrongBinder());
        ...
        case TRANSACTION_printBarCode:
        {
          ...
          int _arg4;
          _arg4 = data.readInt();
          IPosPrinterCallback _arg5;
          _arg5 = IPosPrinterCallback.Stub.asInterface(data.readStrongBinder());
    ...
    public static boolean setDefaultImpl(IPosPrinterService impl) {
